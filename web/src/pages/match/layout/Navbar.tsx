	...
	return (
		<div className="flex justify-between items-center px-2 sm:px-4 py-2 bg-white border-b border-gray-200 shadow-sm">
			<div className="flex items-center space-x-2 sm:space-x-4">
				...
				>
					<h1 className="font-bold text-lg sm:text-xl text-sky-600 flex items-center">
						<svg
							xmlns="http://www.w3.org/2000/svg"
							className="w-5 h-5 sm:w-7 sm:h-7 text-purple-600 mr-1"
							fill="none"
							viewBox="0 0 24 24"
							stroke="currentColor"
							strokeWidth={2}
			...
			<div className="flex items-center space-x-2 sm:space-x-4">
				...
				<div className="flex items-center space-x-1 sm:space-x-2">
					<button
						className="bg-sky-600 hover:bg-sky-700 text-white font-medium px-2 sm:px-3 py-1 rounded text-xs sm:text-sm transition"
						onClick={handleSubmit}
					>
						Submit
					</button>
					<button
						className="bg-sky-100 hover:bg-sky-200 text-sky-700 px-2 sm:px-3 py-1 rounded text-xs sm:text-sm flex items-center space-x-1 transition"
						onClick={handleRun}
					>
						<PlayCircle size={12} />
						<span>Run</span>
			...
			{isMobileMenuOpen && (
				<div className="absolute top-full left-0 right-0 bg-white border-b border-gray-200 md:hidden z-50 shadow-sm">
